...
public class SubscriptionService {
	...
	public static final String INTERNAL_MODI_API = "/api/am/wemodi/subscription";
	...
	public JsonObject getCacheConfigurations()
		...
		String responseString = null;
        JsonElement cacheConfigurations = null;
		try {
		...
		if (responseString != null && !responseString.isEmpty()) {
            cacheConfigurations = new Gson().fromJson(responseString, JsonElement.class);
		}
        return cacheConfigurations == null ? null : cacheConfigurations.getAsJsonObject();
	}
